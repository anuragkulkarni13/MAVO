...
public class graphVisual {
	...
	public static void generateGraphDOT(String newPomFilePath, String newPomPath, String newPomDependencyTreePath, String newPomDependencyCheckReportPath, String treeImgPath)
	{
...
//            System.err.println("Error writing DOT file: " + e.getMessage());
        ...
        dotFormat.append(traverseDOT(newPomFilePath, newPomPath, newPomDependencyTreePath, newPomDependencyCheckReportPath));
        dotFormat.append("}");
...
//            System.err.println("Error writing DOT file: " + e.getMessage());
	...
	public static String traverseDOT(String newPomFilePath, String newPomPath, String newPomDependencyTreePath, String newPomDependencyCheckReportPath)
	{
		String dot = "";
